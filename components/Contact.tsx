...
export default function Contact() {
  const contacts = [
    {
      icon: (
        <svg width="22" height="22" viewBox="0 0 15 15" fill="none" aria-hidden>
          <path
            d="M1.875 1.875H13.125C13.4702 1.875 13.75 2.15483 13.75 2.5V12.5C13.75 12.8452 13.4702 13.125 13.125 13.125H1.875C1.52983 13.125 1.25 12.8452 1.25 12.5V2.5C1.25 2.15483 1.52983 1.875 1.875 1.875ZM7.53788 7.30181L3.52951 3.89856L2.72049 4.85144L7.54569 8.94819L12.284 4.8476L11.466 3.9024L7.53788 7.30181Z"
            fill="currentColor"
          />
        </svg>
      ),
  ...
  return (
    <section
      id="contact"
      className="bg-bg px-6 py-16 lg:px-16 lg:py-24"
    >
      <div className="mx-auto flex max-w-7xl flex-col gap-12 md:flex-row md:justify-between md:gap-16">
        <div className="md:w-[42%]">
          <div className="flex w-max max-w-full flex-col gap-8 lg:gap-12">
            <FadeUp>
              <h2 className="md-text">
                <span className="special-text">Contact</span> me
              </h2>
            ...
            <StaggerContainer className="flex w-max max-w-full flex-col gap-5">
              {contacts.map((contact) => (
                <FadeUp key={contact.medium} className="flex items-center gap-3">
                  <a
                    href={contact.link}
                    target="_blank"
                  ...
                  >
                    <span
                      aria-label={`${contact.medium} link`}
                      className="round-button flex size-12 cursor-pointer items-center justify-center rounded-xl !rounded-xl text-on-brand"
                    >
                      {contact.icon}
                    </span>
                  </a>
        ...
        <div className="md:w-[50%]">
          <div className="mx-auto max-w-lg rounded-2xl border border-border bg-bg-sec p-6 shadow-[var(--shadow-soft)] sm:p-8">
            <ContactForm />
            <p className="mt-4 text-center text-sm">
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://wa.me/2348105715843?text=Hello%2C%20I%20came%20across%20your%20portfolio%20and%20I%27m%20interested%20in%20your%20web%20development%20services.%0A%0AProject%20type%3A%0ABudget%3A%0ATimeline%3A%0A%0ACan%20we%20discuss%20further%3F"
