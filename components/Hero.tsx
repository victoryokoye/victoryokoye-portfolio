  ...
  return (
    <>
      <section className="flex flex-col text-center gap-2 lg:text-left lg:flex-row">
        <div className="bg-brand w-full h-130 lg:w-[50%]"></div>
...
function Stats() {
  ...
  return(
    <div className="flex gap-10 justify-center py-10 lg:w-100">
      <div className="flex flex-col gap-10 md:flex-row">
        <div className="bg-white size-40 flex flex-col items-center justify-center rounded-lg">
          <h1>{stats[0].value}</h1>
